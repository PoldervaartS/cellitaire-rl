...
from tensorflow.keras.models import load_model  # or use your framework's loading method
...
class ModelStorage:
    ...
    @staticmethod
    def update_model(model_id, new_model_object=None, parameters=None, metrics=None):
        metadata = get_metadata(model_id)
        if not metadata:
        ...
        updated_metadata = update_metadata(model_id, parameters=parameters, metrics=metrics)
